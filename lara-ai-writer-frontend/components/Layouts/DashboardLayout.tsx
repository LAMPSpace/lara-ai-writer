                ...
                <nav className={`slide-menu shadow bg-base-0 navbar navbar-light p-0 d-flex flex-column z-1030 ${isMenuOpen ? 'active' : ''}`} id="slide-menu">
                    <div className="sidebar-section flex-grow-1 d-flex flex-column w-100">
                        ...
                        <div className="d-flex align-items-center">
                            ...
                            <Link className="px-4 py-2 text-decoration-none text-secondary" href="admin" data-tooltip="true" title="Dashboard" role="button"><span className="d-flex align-items-center"><MdOutlineAdminPanelSettings className="width-4 height-4 fill-current" /></span></Link>
                        </div>
